...
> **Note:**<br>
> Actual code on `main.js`, No 9 (if for string) is not implemented because the score is declared as number and the value does not come by user input, there will not be any string being put by mistake
