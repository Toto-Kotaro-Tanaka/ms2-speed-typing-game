...
1. Click all the buttons and links to see if they link to the place supposed to go. And for external links to be open in the separate page<br>
...
1. Change a country randomly to see if all the information comes up correctly, including a link to the Wikipedia page
...
>These are very minor issues and not worth mentioning on the website, no further action is taken and left as they are
